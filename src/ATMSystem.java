 ...
 * Created: 2018-02-20
 * Updated: 2018-02-23		Reason: last bugs fixed, ready for submission
 *
 */
public class ATMSystem {
	...
	/**
	 * Main program
	 * @param args arguments passed using command line (no use here)
	 */
	public static void main(String[] args) {
		...
		ATM firstATMA = new ATM(bankA, 35);
		ATM secondATMA = new ATM(bankA, 150);
